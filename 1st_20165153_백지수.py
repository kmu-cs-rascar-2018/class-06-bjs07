#########################################################################
# Date: 2018/08/09 file name: 1st_assignment_main.py Purpose: this code 
# has been generated for the 4 wheels drive body moving object to 
# perform the project with ultra sensor this code is used for the 
# student only
#########################################################################
